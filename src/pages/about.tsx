  ...
  return (
    <div className='mt-1 p-5'>
      <m.div
        ...
        animate={
          isLoaded
            ? {
                ...
                boxShadow: "0 35px 60px -15px rgba(255, 255, 255, 0.2)",
              }
            : {
        ...
        viewport={{ once: true }}
        className='m-4 mt-12 flex gap-16 justify-around items-center rounded-[20px] border-t-[1px] border-l-[1px] relative'>
        <m.div
          initial={false}
          animate={
            isLoaded
